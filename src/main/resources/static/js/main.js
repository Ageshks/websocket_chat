...
function onMessageReceived(payload) {
    ...
    if (message.type === 'JOIN') {
        ...
        messageElement.textContent = message.content; // Display "User joined the chat!"
    } else {
    ...
    if (Notification.permission === 'granted') {
        new Notification(message.type === 'JOIN' ? "New User Joined" : `New message from ${message.sender}`, {
